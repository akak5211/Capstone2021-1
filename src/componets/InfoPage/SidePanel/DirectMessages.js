...
export class DirectMessages extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <span style={{ display: 'flex', alignItems: 'center', fontSize:'1.5rem', marginLeft: 5, marginTop:20}}>
                    <FaRegSmile style={{ marginRight: 10, fontSize: '1.5rem'}} />Friends ({users.length})
                </span>

                <ul style={{ listStyleType: 'none', padding: 0, fontSize:'1.5rem', marginLeft: 3, marginTop: 5}}>
